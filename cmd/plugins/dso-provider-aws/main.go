...
func main() {
	...
	// Using os.Stderr ensures failure is detectable in CI pipelines and log aggregators.
	fmt.Fprintf(os.Stderr, "Error: DSO provider '%s' is not yet implemented.\n", providerName)
	fmt.Fprintf(os.Stderr, "       Full AWS Secrets Manager support is planned for a future release.\n")
